...
<section>
    <div style="width: 70%;margin: 0 auto;" >
        <div style="margin-right: 2%%;margin-left: 20%;width: 60%;">
            <?php
            if ($ligne["IMAGE"]==""){
            }
            elseif (strpos($ligne["IMAGE"],'.mp4')){
                echo '<video width="320" height="240" controls>
                <source src="uploads/'.$ligne["IMAGE"].'">
            </video>';
            }
            elseif (strpos($ligne["IMAGE"],'.mp3')){
                echo '<audio width="320" height="240" controls>
                <source src="uploads/'.$ligne["IMAGE"].'">
            </audio>';
            }
            else{
                echo '<img width="320" height="240" src="uploads/'.$ligne["IMAGE"].'">';
            }
            ?>
        </div>
    </div>
